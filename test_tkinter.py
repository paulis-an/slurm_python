...
5. Сохранить результат, нажав на кнопку \"Save as...\"
    ...
    def run_check(self):
        ...
        # num = int(self.field_num_col.get())
        

    # def choose_column_number(self):
    #     self.root = tk.Tk()
    #     self.root.title("Choose column number \"Email\"")
    #     self.root.geometry("400x150")

    #     self.label = ttk.Label(self.root)
    #     self.label.pack(anchor=tk.CENTER, padx=3, pady=3)
    #     self.number_entry = tk.Entry(self.root)
    #     self.number_entry.pack(anchor=tk.CENTER, padx=3, pady=3)
    #     self.btn_send = tk.Button(self.root, text='Run validation', command=self.check)
    #     self.btn_send.pack(side=tk.TOP, anchor=tk.CENTER, padx=6, pady=6)
